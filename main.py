...
from config import API_KEY, LANGCHAIN_API_KEY, LANGCHAIN_PROJECT_NAME, PLOT_OUTPUT_DIR  # Removed DATASET_FOLDER, DATASET_CSV_PATH
...
with st.sidebar:
    ...
    model_name = st.selectbox("Select Model", ["gpt-3.5-turbo", "gpt-4o", 'gpt-4o-mini', 'o1-mini'], index=0, key="model_name")
